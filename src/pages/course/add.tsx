...
const CourseGroupEdit: React.FC = (props) => {
  ...
  const [{ data: CourseGroupData, loading, error }, newsAPI] = useAxios({
    url: `/api/CourseGroup`,
    method: "GET",
  });
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    if (!formData?.nameEN) missingFields.push("ชื่อสาขาภาษาอังกฤษ");
...
export default CourseGroupEdit;