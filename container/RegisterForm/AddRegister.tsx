...
interface RegisterFormAddRegisterFormModalProps {
    data: RegisterForm ; // replace this with the actual type of your data
}
const RegisterFormAddRegisterFormModal: React.FC<RegisterFormAddRegisterFormModalProps> = ({ data }) => {
...
export default RegisterFormAddRegisterFormModal;
