...
interface AdminmasterAddAdminmasterModalProps {
    data: Adminmaster ; // replace this with the actual type of your data
}
const AdminmasterAddAdminmasterModal: React.FC<AdminmasterAddAdminmasterModalProps> = ({ data }) => {
    ...
    return (
        <>
            <Button className="mx-1 btn gold" bsPrefix="icon" onClick={handleShow}>
                <FaUserNinja />
                <span className="h-tooltiptext">เพิ่มแอดมิน</span>
            </Button>
            <Modal show={show} onHide={handleClose} size='lg'>
                <Modal.Header closeButton>
                    <Modal.Title>แอดมิน </Modal.Title>
...
export default AdminmasterAddAdminmasterModal;
