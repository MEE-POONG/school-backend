...
interface EditAdminmasterModalProps {
    data: Adminmaster;
    apiEdit: () => Promise<any>; // add this line
}
const EditAdminmasterModal: React.FC<EditAdminmasterModalProps> = ({ data, apiEdit }) => {
    ...
    let heading = `ลบข้อมูล : ${data?.adminUsername} ${data.adminPassword} ${data.sex} ${data.tel}${data.email}`;
...
export default EditAdminmasterModal;
