...
interface PromotionAddPromotionModalProps {
    data: Promotion ; // replace this with the actual type of your data
}
const PromotionAddPromotionModal: React.FC<PromotionAddPromotionModalProps> = ({ data }) => {
...
export default PromotionAddPromotionModal;
